...
- 如果把「React 和 Vue 的心智模型本质差异」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Hooks 的核心规则与原理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Fiber 架构与并发渲染」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React 状态管理选型」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Suspense 与异步数据加载」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React Router v6.4+ 的 Data Router 与 loaders」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React 性能优化清单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React 19 关键特性速览」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React + TypeScript 常用类型模式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「React 组件测试要测什么、怎么测」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「列表渲染中 key 的作用与使用陷阱」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「受控组件 vs 非受控组件，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Portal、Error Boundary、Suspense 的协作方式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React 和 Vue 的心智模型本质差异」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「React 和 Vue 的心智模型本质差异」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Hooks 的核心规则与原理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [Hooks, 原理, 追问]
...
如果面试官追问：如果把「Hooks 的核心规则与原理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：useEffect 和 useLayoutEffect 何时选哪个
difficulty: 进阶
...
如果面试官追问：useEffect 和 useLayoutEffect 何时选哪个
...
title: 追问：React 18 自动批处理对 effect 的影响
difficulty: 进阶
tags: [useEffect, 陷阱, 追问]
parent: use-effect-pitfalls
...
如果面试官追问：React 18 自动批处理对 effect 的影响
...
title: 追问：如果把「Fiber 架构与并发渲染」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 资深
...
如果面试官追问：如果把「Fiber 架构与并发渲染」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：Server Action 和 RSC 关系
difficulty: 进阶
tags: [追问]
...
如果面试官追问：Server Action 和 RSC 关系
...
title: 追问：为什么 RSC 能减小 client bundle
difficulty: 进阶
tags: [追问]
parent: react-server-components
...
如果面试官追问：为什么 RSC 能减小 client bundle
...
title: 追问：如果把「React 状态管理选型」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [追问]
...
如果面试官追问：如果把「React 状态管理选型」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Suspense 与异步数据加载」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 资深
...
如果面试官追问：如果把「Suspense 与异步数据加载」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React Router v6.4+ 的 Data Router 与 loaders」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [Router, 数据加载, 追问]
...
如果面试官追问：如果把「React Router v6.4+ 的 Data Router 与 loaders」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React 性能优化清单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [追问]
parent: react-perf
...
如果面试官追问：如果把「React 性能优化清单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React 19 关键特性速览」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 资深
...
如果面试官追问：如果把「React 19 关键特性速览」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React + TypeScript 常用类型模式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「React + TypeScript 常用类型模式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「React 组件测试要测什么、怎么测」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [测试, RTL, 追问]
...
如果面试官追问：如果把「React 组件测试要测什么、怎么测」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「列表渲染中 key 的作用与使用陷阱」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 基础
tags: [Diff, key, 追问]
...
如果面试官追问：如果把「列表渲染中 key 的作用与使用陷阱」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「受控组件 vs 非受控组件，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [表单, 性能, 追问]
...
如果面试官追问：如果把「受控组件 vs 非受控组件，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Portal、Error Boundary、Suspense 的协作方式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [架构, 错误处理, 追问]
...
如果面试官追问：如果把「Portal、Error Boundary、Suspense 的协作方式」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：为什么 React 不强制要求 key 在所有数组里
difficulty: 基础
tags: [list, key, 基础, 追问]
...
如果面试官追问：为什么 React 不强制要求 key 在所有数组里？
...
title: 追问：写一个 demo 演示 index-as-key 导致的 bug
difficulty: 基础
tags: [list, key, 基础, 追问]
parent: react-keys-list-basic
...
如果面试官追问：写一个 demo 演示 index-as-key 导致的 bug
...
- 先把问题拉回「React 列表为什么必须给 key？」的核心机制，说明这个追问考察的是落地边界、失败条件和方案取舍，而不是单点定义。
- 可以补充一个真实项目语境：上线前先约定输入输出、失败兜底和观测指标，避免只在 demo 场景下成立。
...
如果面试官追问：key 变化时组件会发生什么（卸载 + 重新挂载，state 丢失）
