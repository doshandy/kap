...
followups: [js-error-types-basic-followup-1]
difficulty: 基础
tags: [错误, 监听, 基础]
...
followups: [tbt-and-long-task-collection-followup-1, tbt-and-long-task-collection-followup-4, tbt-and-long-task-collection-followup-5]
...
followups: [source-map-stack-trace-followup-1, source-map-stack-trace-followup-4, source-map-stack-trace-followup-5]
difficulty: 进阶
tags: [SourceMap, 错误定位]
...
followups: [rrweb-on-demand-recording-followup-1, rrweb-on-demand-recording-followup-4, rrweb-on-demand-recording-followup-5]
difficulty: 资深
...
title: 追问：推动「前端错误捕获链路应该怎么搭」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 基础
...
如果面试官追问：推动「前端错误捕获链路应该怎么搭」落地时，你会如何设计灰度、回滚和迁移路径？
...
- 团队推进重点不是一次性重写，而是把「前端错误捕获链路应该怎么搭」拆成可验证的小步骤，逐步替换高风险部分。

## source-map-symbolicate-followup-1

title: 追问：「Source Map 上传与错误还原」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「Source Map 上传与错误还原」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「RUM 与 Web Vitals 才能告诉你真实用户体验」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「RUM 与 Web Vitals 才能告诉你真实用户体验」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「埋点模型设计：事件、属性、上下文、会话」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [埋点, 数据模型, 追问]
parent: event-model
...
如果面试官追问：推动「埋点模型设计：事件、属性、上下文、会话」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：推动「Beacon、fetch keepalive 与监控上报通道怎么选」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
...
如果面试官追问：推动「Beacon、fetch keepalive 与监控上报通道怎么选」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「会话回放、采样与告警阈值」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「会话回放、采样与告警阈值」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「可观测性与隐私合规的平衡」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [隐私合规, GDPR, 追问]
...
如果面试官追问：推动「可观测性与隐私合规的平衡」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「OpenTelemetry 在前端的接入」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
...
如果面试官追问：「OpenTelemetry 在前端的接入」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：针对「前端 A/B 测试与特性开关的工程实现」，你会优先补哪些边界用例和回归用例
difficulty: 进阶
...
如果面试官追问：针对「前端 A/B 测试与特性开关的工程实现」，你会优先补哪些边界用例和回归用例？
...
title: 追问：推动「前端如何全链路捕获错误并上报」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [监控, 错误, 追问]
...
如果面试官追问：推动「前端如何全链路捕获错误并上报」落地时，你会如何设计灰度、回滚和迁移路径？
...
- 落地时先收敛改动面：选低风险页面或模块试点，保留旧路径作为对照。
- 迁移计划要说明数据兼容、配置开关、监控指标和失败后的恢复路径。
- 团队推进重点不是一次性重写，而是把「前端如何全链路捕获错误并上报」拆成可验证的小步骤，逐步替换高风险部分。

## white-screen-detection-followup-1

title: 追问：推动「前端白屏怎么检测」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 资深
tags: [可观测性, 监控, 高频, 追问]
...
如果面试官追问：推动「前端白屏怎么检测」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：推动「前端怎么承接 A/B 实验」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [可观测性, 实验, 高频, 追问]
...
如果面试官追问：推动「前端怎么承接 A/B 实验」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「JS 错误监听都有哪几个钩子？各管什么」在真实项目里最容易踩到哪些边界条件
difficulty: 基础
tags: [错误, 监听, 基础, 追问]
...
如果面试官追问：「JS 错误监听都有哪几个钩子？各管什么」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：你会先看哪些指标来判断「线上 LCP 怎么收集？AB / 灰度 / 大盘 / 业务关联怎么做」是不是当前性能瓶颈
difficulty: 资深
tags: [LCP, RUM, 高频, 追问]
...
如果面试官追问：你会先看哪些指标来判断「线上 LCP 怎么收集？AB / 灰度 / 大盘 / 业务关联怎么做」是不是当前性能瓶颈？
...
title: 追问：「TBT / Long Task 怎么采集？requestIdleCallback 上报权衡」上线后如何设计验证和观测指标
difficulty: 资深
...
如果面试官追问：「TBT / Long Task 怎么采集？requestIdleCallback 上报权衡」在真实项目里最容易踩到哪些边界条件？

### 答案要点

#### 核心回答

- 先界定「TBT / Long Task 怎么采集？requestIdleCallback 上报权衡」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕核心机制展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「W3C 标准：任务执行 ≥ 50ms 就算 long task」要进一步补到边界条件里，而不是只复述结论。

## tbt-and-long-task-collection-followup-4

title: 追问：「TBT / Long Task 怎么采集？requestIdleCallback 上报权衡」如果规模或约束变化，你会怎么调整方案
difficulty: 资深
tags: [TBT, Long Task, 上报, 高频, 追问]
parent: tbt-and-long-task-collection
...
title: 追问：「TBT / Long Task 怎么采集？requestIdleCallback 上报权衡」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
tags: [TBT, Long Task, 上报, 高频, 追问]
parent: tbt-and-long-task-collection
...
title: 追问：「Source Map：栈解析定位到源码行列」上线后如何设计验证和观测指标
difficulty: 进阶
...
如果面试官追问：「Source Map：栈解析定位到源码行列」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「Source Map：栈解析定位到源码行列」如果规模或约束变化，你会怎么调整方案
difficulty: 进阶
tags: [SourceMap, 错误定位, 追问]
parent: source-map-stack-trace
...
title: 追问：「Source Map：栈解析定位到源码行列」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [SourceMap, 错误定位, 追问]
parent: source-map-stack-trace
...
title: 追问：推动「白屏检测：从根节点扫描到采样像素」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 资深
tags: [白屏, 监控, 追问]
...
如果面试官追问：推动「白屏检测：从根节点扫描到采样像素」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「大依赖按需下发：rrweb 百万级用户场景」上线后如何设计验证和观测指标
difficulty: 资深
...
如果面试官追问：「大依赖按需下发：rrweb 百万级用户场景」在真实项目里最容易踩到哪些边界条件？

### 答案要点

#### 核心回答

- 先界定「大依赖按需下发：rrweb 百万级用户场景」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕核心机制展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「rrweb 库 + 序列化数据量大，全量下发拖累首屏」要进一步补到边界条件里，而不是只复述结论。

## rrweb-on-demand-recording-followup-4

title: 追问：「大依赖按需下发：rrweb 百万级用户场景」如果规模或约束变化，你会怎么调整方案
difficulty: 资深
tags: [rrweb, 录屏, 大依赖, 高频, 追问]
parent: rrweb-on-demand-recording
...
title: 追问：「大依赖按需下发：rrweb 百万级用户场景」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
tags: [rrweb, 录屏, 大依赖, 高频, 追问]
parent: rrweb-on-demand-recording
