...
- 如果把「测试金字塔为什么不是“多写单测”这么简单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Mock、Spy、Stub 在前端测试中的边界」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「组件测试应该站在用户视角还是实现视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「E2E 与视觉回归分别覆盖什么风险」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「MSW、契约测试与前后端协作」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「覆盖率、稳定性与 CI 中的测试门禁」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Playwright 高级用法（trace / fixtures / projects）」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「Flaky 测试是怎么来的，怎么治理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「测试金字塔 / 测试奖杯 怎么选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「测试数据怎么造？怎么避免脏数据互相干扰」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「异步代码 / 定时器 / Stream 怎么测？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
- 如果把「视觉回归测试怎么做？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「测试金字塔为什么不是“多写单测”这么简单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 基础
tags: [测试策略, 金字塔, 追问]
parent: test-pyramid
...
如果面试官追问：如果把「测试金字塔为什么不是“多写单测”这么简单」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Mock、Spy、Stub 在前端测试中的边界」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [Mock, 单元测试, 追问]
...
如果面试官追问：如果把「Mock、Spy、Stub 在前端测试中的边界」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「组件测试应该站在用户视角还是实现视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「组件测试应该站在用户视角还是实现视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「E2E 与视觉回归分别覆盖什么风险」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [E2E, 视觉回归, 追问]
parent: e2e-visual
...
如果面试官追问：如果把「E2E 与视觉回归分别覆盖什么风险」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「MSW、契约测试与前后端协作」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [MSW, 契约测试, 追问]
parent: msw-contract
...
如果面试官追问：如果把「MSW、契约测试与前后端协作」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「覆盖率、稳定性与 CI 中的测试门禁」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [覆盖率, CI, 追问]
parent: coverage-ci
...
如果面试官追问：如果把「覆盖率、稳定性与 CI 中的测试门禁」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Playwright 高级用法」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「Playwright 高级用法（trace / fixtures / projects）」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Flaky 测试是怎么来的，怎么治理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 资深
tags: [Flaky, 稳定性, 追问]
parent: flaky-tests
...
如果面试官追问：如果把「Flaky 测试是怎么来的，怎么治理」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「测试金字塔 / 测试奖杯 怎么选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [测试, 架构, 追问]
...
如果面试官追问：如果把「测试金字塔 / 测试奖杯 怎么选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「测试数据怎么造？怎么避免脏数据互相干扰」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [测试, 数据, 高频, 追问]
...
如果面试官追问：如果把「测试数据怎么造？怎么避免脏数据互相干扰」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「异步代码 / 定时器 / Stream 怎么测？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [测试, 异步, 高频, 追问]
...
如果面试官追问：如果把「异步代码 / 定时器 / Stream 怎么测？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「视觉回归测试怎么做？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [测试, 视觉, UI, 追问]
...
如果面试官追问：如果把「视觉回归测试怎么做？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
如果面试官追问：怎么处理 flaky 测试（重试、隔离、稳态等待）
