...
links: [05-browser/service-worker]
difficulty: 资深
...
title: 追问：你会先看哪些指标来判断「hash 命名、长效缓存与 HTML 短缓存是发布基础功」是不是当前性能瓶颈
difficulty: 基础
tags: [缓存, 发布, 追问]
...
如果面试官追问：你会先看哪些指标来判断「hash 命名、长效缓存与 HTML 短缓存是发布基础功」是不是当前性能瓶颈？
...
title: 追问：「动态 import 失败与旧版本 chunk 被清理怎么处理」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [动态加载, 容错, 追问]
...
如果面试官追问：「动态 import 失败与旧版本 chunk 被清理怎么处理」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「灰度发布、回滚与零停机切换」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [灰度, 回滚, 追问]
parent: gray-release
...
如果面试官追问：推动「灰度发布、回滚与零停机切换」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「Service Worker 更新策略的取舍」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「Service Worker 更新策略的取舍」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「history 路由、404 fallback 与静态托管适配」在真实项目里最容易踩到哪些边界条件
difficulty: 基础
tags: [路由, 静态部署, 追问]
parent: spa-fallback
...
如果面试官追问：「history 路由、404 fallback 与静态托管适配」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「包体分析与发布前治理」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [包体治理, 分析, 追问]
...
如果面试官追问：推动「包体分析与发布前治理」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「Tree-shaking 失效的常见原因」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「Tree-shaking 失效的常见原因」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「PWA Service Worker 升级策略」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
...
如果面试官追问：「PWA Service Worker 升级策略」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「SemVer 与自动化发版（changeset / semantic-release）」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [发布, 工程化, 追问]
...
如果面试官追问：推动「SemVer 与自动化发版（changeset / semantic-release）」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：推动「前端 CI/CD 流水线怎么设计」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 资深
...
如果面试官追问：推动「前端 CI/CD 流水线怎么设计」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：你会先看哪些指标来判断「一道题打包优化全部场景」是不是当前性能瓶颈
difficulty: 资深
tags: [构建, 性能, 高频, 追问]
...
如果面试官追问：你会先看哪些指标来判断「一道题打包优化全部场景」是不是当前性能瓶颈？
