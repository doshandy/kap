...
title: 追问：在 Vue 项目里落地「主流框架的响应式模型对比」时，响应式边界和组件更新时机要注意什么
difficulty: 资深
tags: [响应式, 框架, 追问]
...
如果面试官追问：在 Vue 项目里落地「主流框架的响应式模型对比」时，响应式边界和组件更新时机要注意什么？
...
title: 追问：你会先看哪些指标来判断「SPA / SSR / SSG / ISR / RSC / Streaming / Resumability」是不是当前性能瓶颈
difficulty: 资深
tags: [渲染策略, SSR, 追问]
...
如果面试官追问：你会先看哪些指标来判断「SPA / SSR / SSG / ISR / RSC / Streaming / Resumability」是不是当前性能瓶颈？
...
title: 追问：你会先看哪些指标来判断「各框架运行时体积与启动成本对比」是不是当前性能瓶颈
difficulty: 进阶
tags: [体积, 性能, 追问]
...
如果面试官追问：你会先看哪些指标来判断「各框架运行时体积与启动成本对比」是不是当前性能瓶颈？
...
title: 追问：推动「生态、招聘和团队工程化的取舍」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [选型, 团队, 追问]
...
如果面试官追问：推动「生态、招聘和团队工程化的取舍」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「老项目迁移 / 多框架共存怎么做」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
tags: [迁移, 微前端, 追问]
...
如果面试官追问：「老项目迁移 / 多框架共存怎么做」在真实项目里最容易踩到哪些边界条件？
...
- 落地时先收敛改动面：选低风险页面或模块试点，保留旧路径作为对照。
- 迁移计划要说明数据兼容、配置开关、监控指标和失败后的恢复路径。
- 团队推进重点不是一次性重写，而是把「老项目迁移 / 多框架共存怎么做」拆成可验证的小步骤，逐步替换高风险部分。

## angular-distinct-followup-1

title: 追问：「Angular 的核心差异和适合场景」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [Angular, DI, 追问]
...
如果面试官追问：「Angular 的核心差异和适合场景」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「Qwik 与 Resumability 模型」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
...
如果面试官追问：「Qwik 与 Resumability 模型」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「Svelte 5 与 Solid 的设计哲学」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 资深
...
如果面试官追问：推动「Svelte 5 与 Solid 的设计哲学」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：在 Vue 项目里落地「Signal / 细粒度响应式（Solid / Vue Vapor）的本质优势」时，响应式边界和组件更新时机要注意什么
difficulty: 资深
tags: [响应式, 框架, 追问]
...
如果面试官追问：在 Vue 项目里落地「Signal / 细粒度响应式（Solid / Vue Vapor）的本质优势」时，响应式边界和组件更新时机要注意什么？
...
title: 追问：你会先看哪些指标来判断「Hydration vs Resumability：Qwik 为什么"不需要 hydration"」是不是当前性能瓶颈
difficulty: 资深
...
如果面试官追问：你会先看哪些指标来判断「Hydration vs Resumability：Qwik 为什么"不需要 hydration"」是不是当前性能瓶颈？
...
title: 追问：在 Vue 项目里落地「老板让你选 React 还是 Vue 做新项目，你怎么答」时，响应式边界和组件更新时机要注意什么
difficulty: 基础
tags: [选型, 框架, 基础, 追问]
...
如果面试官追问：在 Vue 项目里落地「老板让你选 React 还是 Vue 做新项目，你怎么答」时，响应式边界和组件更新时机要注意什么？
...
- 验证要从可复现样例开始：准备正向、边界和失败用例，确认「老板让你选 React 还是 Vue 做新项目，你怎么答」不是只在理想输入下成立。
