...
- 直接围绕「在「原型链污染为什么危险，如何防」进入长周期维护后，你会重点巡检哪些与 原型链污染 相关的高风险边界点」作答：攻击者通过 `__proto__`、constructor.prototype 等路径污染全局原型
...
- 直接围绕「以「原型链污染为什么危险，如何防」为例，你会如何围绕 原型链污染 定义「原型链污染为什么危险，如何防」生效的判据，并用测试与监控长期验证」作答：攻击者通过 `__proto__`、constructor.prototype 等路径污染全局原型
...
- 直接围绕「从工程落地角度看，当需求规模、团队资源或兼容性要求变化时，你会如何围绕 原型链污染 重排「原型链污染为什么危险，如何防」方案优先级」作答：攻击者通过 `__proto__`、constructor.prototype 等路径污染全局原型
