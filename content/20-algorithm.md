...
followups: [promise-handwritten-followup-1]
difficulty: 资深
tags: [Promise, 手写, 高频]
...
title: 追问：「时间复杂度与前端真实意义」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 基础
tags: [复杂度, 方法论, 追问]
parent: complexity
...
如果面试官追问：「时间复杂度与前端真实意义」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「时间复杂度与前端真实意义」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「列表渲染、搜索建议、树遍历、diff、埋点聚合都可能因复杂度失控而卡主线程」要进一步补到边界条件里，而不是只复述结论。

## two-pointer-sliding-window-followup-1

title: 追问：「双指针与滑动窗口模板」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [双指针, 滑动窗口, 追问]
...
如果面试官追问：「双指针与滑动窗口模板」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「前缀和与差分数组」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [前缀和, 追问]
parent: prefix-sum
...
如果面试官追问：「前缀和与差分数组」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「链表经典题：反转、合并、环检测」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [链表, 双指针, 追问]
...
如果面试官追问：「链表经典题：反转、合并、环检测」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「二叉树遍历：递归、迭代、Morris」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [树, DFS, BFS, 追问]
...
如果面试官追问：「二叉树遍历：递归、迭代、Morris」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「二叉树遍历：递归、迭代、Morris」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「前/中/后序的递归本质相同，区别只是访问根节点的时机」要进一步补到边界条件里，而不是只复述结论。

## debounce-throttle-handwritten-followup-1

title: 追问：「手写防抖与节流（含 cancel/leading/trailing）」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [手写, 高频, 追问]
...
如果面试官追问：「手写防抖与节流（含 cancel/leading/trailing）」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：「手写 Promise.all / allSettled / race / 限流并发」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
...
如果面试官追问：「手写 Promise.all / allSettled / race / 限流并发」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：你会先看哪些指标来判断「手写 LRU 缓存（O(1) 读写）」是不是当前性能瓶颈
difficulty: 资深
tags: [缓存, 手写, 高频, 追问]
parent: lru-cache
...
如果面试官追问：你会先看哪些指标来判断「手写 LRU 缓存（O(1) 读写）」是不是当前性能瓶颈？
...
title: 追问：「手写数组扁平化（多种实现 + 限制深度）」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [数组, 手写, 追问]
...
如果面试官追问：「手写数组扁平化（多种实现 + 限制深度）」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「二分查找的边界陷阱」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [二分, 高频, 追问]
...
如果面试官追问：「二分查找的边界陷阱」在真实项目里最容易踩到哪些边界条件？

### 答案要点

#### 核心回答

- 先界定「二分查找的边界陷阱」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕核心机制展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「三个易错点：循环条件 < vs <=、mid 计算溢出、left/right 更新方向」要进一步补到边界条件里，而不是只复述结论。

## dp-classic-followup-1

title: 追问：「DP 经典题：爬楼梯、最长上升子序列、编辑距离」在真实项目里最容易踩到哪些边界条件
difficulty: 资深
tags: [DP, 高频, 追问]
parent: dp-classic
...
如果面试官追问：「DP 经典题：爬楼梯、最长上升子序列、编辑距离」在真实项目里最容易踩到哪些边界条件？

### 答案要点

#### 核心回答

- 先界定「DP 经典题：爬楼梯、最长上升子序列、编辑距离」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕核心机制展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「爬楼梯：状态转移 f(n) = f(n-1) + f(n-2)，可滚动变量优化」要进一步补到边界条件里，而不是只复述结论。

## frontend-real-world-followup-1

title: 追问：推动「前端实战中的算法：虚拟列表 / 路由匹配 / Trie 搜索」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 资深
tags: [工程实战, 追问]
...
如果面试官追问：推动「前端实战中的算法：虚拟列表 / 路由匹配 / Trie 搜索」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「图的 BFS / DFS 与前端真实场景」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [图, BFS, DFS, 追问]
...
如果面试官追问：「图的 BFS / DFS 与前端真实场景」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「图的 BFS / DFS 与前端真实场景」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「BFS：层次遍历、最短路径、最少跳数；用 queue 实现」要进一步补到边界条件里，而不是只复述结论。

## bit-manipulation-followup-1

title: 追问：你会先看哪些指标来判断「位运算技巧与前端用例」是不是当前性能瓶颈
difficulty: 进阶
tags: [位运算, 性能, 追问]
...
如果面试官追问：你会先看哪些指标来判断「位运算技巧与前端用例」是不是当前性能瓶颈？
...
title: 追问：你会先看哪些指标来判断「实现一个 LRU 缓存（用 Map 的简洁实现）」是不是当前性能瓶颈
difficulty: 进阶
tags: [数据结构, 手写, 高频, 追问]
...
如果面试官追问：你会先看哪些指标来判断「实现一个 LRU 缓存（用 Map 的简洁实现）」是不是当前性能瓶颈？
...
title: 追问：「合并区间」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 基础
tags: [数组, 排序, 高频, 追问]
...
如果面试官追问：「合并区间」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「合并区间」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「时间 O(n log n)，瓶颈在排序」要进一步补到边界条件里，而不是只复述结论。

## promise-all-impl-followup-1

title: 追问：「手写实现 Promise.all」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
tags: [Promise, 手写, 高频, 追问]
...
如果面试官追问：「手写实现 Promise.all」在真实项目里最容易踩到哪些边界条件？

### 答案要点

#### 核心回答

- 先界定「手写实现 Promise.all」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕核心机制展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「兼容数组与可迭代对象（用 for...of）」要进一步补到边界条件里，而不是只复述结论。

## kth-largest-followup-1

title: 追问：「数组中第 K 大的元素（快速选择 / 小顶堆）」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [排序, 堆, 高频, 追问]
parent: kth-largest
...
如果面试官追问：「数组中第 K 大的元素（快速选择 / 小顶堆）」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「位运算高频技巧一题打尽」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [算法, 位运算, 高频, 追问]
...
如果面试官追问：「位运算高频技巧一题打尽」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「滑动窗口进阶：变长窗口 + 不变量维护」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 资深
tags: [算法, 滑动窗口, 高频, 追问]
...
如果面试官追问：「滑动窗口进阶：变长窗口 + 不变量维护」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「单调栈 / 单调队列高频题」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 资深
...
如果面试官追问：「单调栈 / 单调队列高频题」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「前缀和 / 差分进阶：二维 + 区间更新」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [算法, 前缀和, 高频, 追问]
...
如果面试官追问：「前缀和 / 差分进阶：二维 + 区间更新」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「前缀和 / 差分进阶：二维 + 区间更新」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「构造：pre[i + 1] = pre[i] + a[i]」要进一步补到边界条件里，而不是只复述结论。

## merge-intervals-deep-followup-1

title: 追问：「合并重叠区间（进阶：复杂度 / 边界 / 变体）」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [区间, 排序, 高频, 进阶, 追问]
...
如果面试官追问：「合并重叠区间（进阶：复杂度 / 边界 / 变体）」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：如果数据规模扩大一个数量级，你会如何调整数据结构或算法
difficulty: 进阶
tags: [区间, 排序, 高频, 进阶, 追问]
parent: merge-intervals-deep
...
如果面试官追问：如果数据规模扩大一个数量级，你会如何调整数据结构或算法？
