...
followups: [chart-library-choice-basic-followup-1]
links: [canvas-svg, canvas-vs-svg-vs-webgl, chart-export-printing]
difficulty: 基础
tags: [可视化, 选型, 基础]
...
title: 追问：「Canvas 与 SVG 如何选」在真实项目里最容易踩到哪些边界条件
difficulty: 基础
tags: [Canvas, SVG, 追问]
parent: canvas-svg
...
如果面试官追问：「Canvas 与 SVG 如何选」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：你会先看哪些指标来判断「ECharts 大数据渲染优化思路」是不是当前性能瓶颈
difficulty: 进阶
tags: [ECharts, 性能, 追问]
...
如果面试官追问：你会先看哪些指标来判断「ECharts 大数据渲染优化思路」是不是当前性能瓶颈？
...
title: 追问：「D3 的核心思想不是“画图库”，而是数据驱动映射」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [D3, 数据映射, 追问]
parent: d3-thinking
...
如果面试官追问：「D3 的核心思想不是“画图库”，而是数据驱动映射」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「requestAnimationFrame 与图形动画节奏控制」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [动画, RAF, 追问]
...
如果面试官追问：「requestAnimationFrame 与图形动画节奏控制」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「WebGL 与 WebGPU 的前端视角」在真实项目里最容易踩到哪些边界条件
difficulty: 进阶
...
如果面试官追问：「WebGL 与 WebGPU 的前端视角」在真实项目里最容易踩到哪些边界条件？
...
title: 追问：推动「大屏适配与多分辨率设计」落地时，你会如何设计灰度、回滚和迁移路径
difficulty: 进阶
tags: [大屏, 适配, 追问]
...
如果面试官追问：推动「大屏适配与多分辨率设计」落地时，你会如何设计灰度、回滚和迁移路径？
...
title: 追问：「图表交互的几个关键点（联动 / hover / brush / 缩放）」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [可视化, 交互, 追问]
...
如果面试官追问：「图表交互的几个关键点（联动 / hover / brush / 缩放）」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「D3 力导向图（Force-directed Graph）实战要点」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 资深
tags: [D3, 力导向, 图, 追问]
...
如果面试官追问：「D3 力导向图（Force-directed Graph）实战要点」有哪些容易漏掉的边界输入和复杂度陷阱？

### 答案要点

#### 核心回答

- 先界定「D3 力导向图（Force-directed Graph）实战要点」的适用条件，再说明哪些输入、运行环境或团队约束会让默认方案失效。
- 围绕复杂度和正确性展开：正常路径要能讲清楚，异常路径要说明降级、替代方案和用户可见影响。
- 原题中的关键点「物理仿真：d3-force 默认 N²，节点过千就会卡；用 simulation.alphaDecay 加快收敛」要进一步补到边界条件里，而不是只复述结论。

## canvas-vs-svg-vs-webgl-followup-1

title: 追问：你会先看哪些指标来判断「Canvas / SVG / WebGL 怎么选，性能边界在哪」是不是当前性能瓶颈
difficulty: 进阶
...
如果面试官追问：你会先看哪些指标来判断「Canvas / SVG / WebGL 怎么选，性能边界在哪」是不是当前性能瓶颈？
...
title: 追问：「地图可视化怎么做？数据点 / 热力图 / 行政区划」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [可视化, 地图, 高频, 追问]
...
如果面试官追问：「地图可视化怎么做？数据点 / 热力图 / 行政区划」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「图表 / 看板怎么导出图片 / PDF」有哪些容易漏掉的边界输入和复杂度陷阱
difficulty: 进阶
tags: [可视化, 导出, PDF, 追问]
...
如果面试官追问：「图表 / 看板怎么导出图片 / PDF」有哪些容易漏掉的边界输入和复杂度陷阱？
...
title: 追问：「ECharts、AntV、D3、Chart.js、Plotly 怎么选」在真实项目里最容易踩到哪些边界条件
difficulty: 基础
tags: [可视化, 选型, 基础, 追问]
...
如果面试官追问：「ECharts、AntV、D3、Chart.js、Plotly 怎么选」在真实项目里最容易踩到哪些边界条件？
