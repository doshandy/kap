...
followups: [canvas-svg-followup-1]
difficulty: 基础
tags: [Canvas, SVG]
...
- 如果把「Canvas 与 SVG 如何选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [chart-performance-followup-1]
difficulty: 进阶
tags: [ECharts, 性能]
...
- 如果把「ECharts 大数据渲染优化思路」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [d3-thinking-followup-1]
difficulty: 进阶
tags: [D3, 数据映射]
...
- 如果把「D3 的核心思想不是“画图库”，而是数据驱动映射」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [animation-raf-followup-1]
difficulty: 进阶
tags: [动画, RAF]
...
- 如果把「requestAnimationFrame 与图形动画节奏控制」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [webgl-webgpu-followup-1]
difficulty: 进阶
tags: [WebGL, WebGPU]
...
- 如果把「WebGL 与 WebGPU 的前端视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 大屏适配与多分辨率设计
followups: [dashboard-adaptation-followup-1]
difficulty: 进阶
tags: [大屏, 适配]
...
- 如果把「大屏适配与多分辨率设计」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [chart-interaction-tooltip-followup-1]
difficulty: 进阶
tags: [可视化, 交互]
...
- 如果把「图表交互的几个关键点（联动 / hover / brush / 缩放）」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [d3-force-network-followup-1]
difficulty: 资深
tags: [D3, 力导向, 图]
...
- 如果把「D3 力导向图（Force-directed Graph）实战要点」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [canvas-vs-svg-vs-webgl-followup-1]
difficulty: 进阶
...
- 如果把「Canvas / SVG / WebGL 怎么选，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [map-visualization-followup-1]
difficulty: 进阶
tags: [可视化, 地图, 高频]
...
- 如果把「地图可视化怎么做？数据点 / 热力图 / 行政区划」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
followups: [chart-export-printing-followup-1]
difficulty: 进阶
tags: [可视化, 导出, PDF]
...
- 如果把「图表 / 看板怎么导出图片 / PDF？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Canvas 与 SVG 如何选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 基础
tags: [Canvas, SVG, 追问]
parent: canvas-svg
...
如果面试官追问：如果把「Canvas 与 SVG 如何选」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「ECharts 大数据渲染优化思路」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [ECharts, 性能, 追问]
...
如果面试官追问：如果把「ECharts 大数据渲染优化思路」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「D3 的核心思想不是“画图库”，而是数据驱动映射」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [D3, 数据映射, 追问]
parent: d3-thinking
...
如果面试官追问：如果把「D3 的核心思想不是“画图库”，而是数据驱动映射」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「requestAnimationFrame 与图形动画节奏控制」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [动画, RAF, 追问]
...
如果面试官追问：如果把「requestAnimationFrame 与图形动画节奏控制」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「WebGL 与 WebGPU 的前端视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「WebGL 与 WebGPU 的前端视角」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「大屏适配与多分辨率设计」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [大屏, 适配, 追问]
...
如果面试官追问：如果把「大屏适配与多分辨率设计」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「图表交互的几个关键点」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [可视化, 交互, 追问]
...
如果面试官追问：如果把「图表交互的几个关键点（联动 / hover / brush / 缩放）」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「D3 力导向图实战要点」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 资深
tags: [D3, 力导向, 图, 追问]
...
如果面试官追问：如果把「D3 力导向图（Force-directed Graph）实战要点」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「Canvas / SVG / WebGL 怎么选，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
...
如果面试官追问：如果把「Canvas / SVG / WebGL 怎么选，性能边界在哪」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「地图可视化怎么做？数据点 / 热力图 / 行政区划」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [可视化, 地图, 高频, 追问]
...
如果面试官追问：如果把「地图可视化怎么做？数据点 / 热力图 / 行政区划」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
title: 追问：如果把「图表 / 看板怎么导出图片 / PDF？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍
difficulty: 进阶
tags: [可视化, 导出, PDF, 追问]
...
如果面试官追问：如果把「图表 / 看板怎么导出图片 / PDF？」用到真实项目里，你会重点关注哪些边界、验证手段和取舍？
...
如果面试官追问：上万点散点图卡顿怎么办（WebGL / Canvas 替代 SVG / 抽样）
...
如果面试官追问：图表交互（tooltip / brush / linked view）怎么设计
