...
- **28 个分类 / 435+ 题**：覆盖 JS / TS / Vue / React / CSS / 浏览器 / 网络 / 性能 / 工程化 / Node / 架构 / 安全 / 测试 / 可观测 / 构建发布 / 跨端 / 可视化 / 算法 / **AI 前端工程化** / 面试专题 / 软技能 / a11y-i18n / 全栈 Meta / Rust+WASM / 浏览器扩展 / 数据平台案例 / 客服 IM 实战
- **AI 前端 48 题**：基础（Token / Embedding / 采样参数）→ 进阶（流式 / 重试 / Cache / Memory）→ 资深（Agent / RAG / 模型路由 / 状态机）→ 工程化（Eval / A/B / Cost / Trace / 多租户 / Guardrails / CI·CD / 数据回流）
